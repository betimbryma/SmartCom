...
import at.ac.tuwien.dsg.smartcom.manager.messaging.adapter.StatefulAdapter;
import at.ac.tuwien.dsg.smartcom.manager.messaging.policies.privacy.peer.AlwaysFailsDummyPeerPrivacyPolicy;
...
public class MessagingAndRoutingManagerIT {
    ...
    public void setUp() throws Exception {
		...
		pico.addComponent(MessageLogLevel.class, MessageLogLevel.NONE);
    	...
    	adManager.registerOutputAdapter(StatefulAdapter.class);
    ...
    public void testCollectiveDeliveryAcknowledged() throws Exception {
    	...
    	Message msg = new Message.MessageBuilder()
								 ...
								 .setDeliveryPolicy(DeliveryPolicy.Message.ACKNOWLEDGED)
    							 .setType(null)
    							 .create();
    ...
    public void testCollectiveDeliveryUnacknowledged() throws Exception {
    	...
    	Message msg = new Message.MessageBuilder()
    							 ...
    							 .setSenderId(PredefinedMessageHelper.taskExecutionEngine)
    							 .setConversationId("conversation 1")
								 .setDeliveryPolicy(DeliveryPolicy.Message.UNACKNOWLEDGED)
    							 .setType(null) 
    							 .create();
